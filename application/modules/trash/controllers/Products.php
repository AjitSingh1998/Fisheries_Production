...
class Products extends MY_Controller {
	...
	function index(){
		redirect('trash/products/products');
	}
	...
	function product_type(){
		$actions = checkUserPermission('trash/products/product_type', $this->uri->segment(4));
	...
	function product_category(){
		$actions = checkUserPermission('trash/products/product_category', $this->uri->segment(4));
	...
	function products(){
		...
		$actions = checkUserPermission('trash/products/products', $this->uri->segment(4));
