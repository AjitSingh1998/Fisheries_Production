      ...
      <tbody id="secondary" class="table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                <button type="button" class="btn btn-danger btn-xs remove_row" data-id="<?=$db_id?>" title="Delete Fisherman">
...
<h5 class="text-danger"><strong>Primary Fisherman Detail:</strong></h5>
<div class="row">
