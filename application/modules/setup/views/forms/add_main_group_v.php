...
<div class="row">
    ...
    <div class="col-sm-4">
    	<div class="form-group">
            <label class="control-label"> Main Group Name <span class="symbol required"></span> </label>
...
<div class="row">
    <div class="col-sm-4">
		<div class="form-group">
            <label class="control-label"> Product Opening Balance </label>
            <input type="text" class="form-control" name="product_balance" value="<?=set_value('product_balance', $product_balance)?>">
        </div>
    </div>
    <div class="col-sm-4">
		<div class="form-group">
            <label class="control-label"> Advance wages balance </label>
            <input type="text" class="form-control" name="wages_balance" value="<?=set_value('wages_liability', $wages_balance)?>">
        </div>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
