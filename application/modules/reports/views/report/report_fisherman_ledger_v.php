        ...
        <div class="panel-heading border-light">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control select-fisherman" name="fisherman"></select>
              	</div>
               
                <div class="col-md-3">
                    <label>&nbsp; </label>
                    <div class="input-group">
                        <button type="button" class="btn btn-primary find_report" data-url="reports/ajax_fisherman_ledger"> <i class="fa fa-search"></i> Find</button>&nbsp;
            ...
            <table class="table table-striped table-bordered" id="data-table-grid">
                <thead>                    
                    <tr>
                        ...
                        <!--<th width="10%">Advance Wages</th>
                        <th width="10%"><span data-toggle="tooltip" title="Product Outward Deduction">PO Deduction</span></th>
                        <th width="10%"><span data-toggle="tooltip" title="Advance Wages Deduction">AW Deduction</span></th>
                        <th width="10%">Total Borrow</th>
