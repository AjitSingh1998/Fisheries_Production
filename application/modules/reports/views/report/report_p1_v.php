    ...
    <div class="panel panel-white" id="report_panel">
        <div class="panel-heading border-light">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <label>&nbsp; </label>
                    <div class="input-group">
                        <button type="button" class="btn btn-primary find_report" data-url="reports/ajax_p1_report"> <i class="fa fa-search"></i> Find</button>&nbsp;
        ...
        <div class="panel-body">
            <table class="table table-striped table-bordered" id="data-table-grid">
                <thead>
                    <tr>
                        <th colspan="20" style="text-align:center; font-size: 20px">म.प्र. मत्स्य महासंघ (सह.) मर्यादित वाण सागर जलाशय <br> दैनिक मत्स्य उत्पादन रिपोर्ट (सदस्यवार) </th>
                    </tr>
                    <tr>
                        <th colspan="10" style="text-align:left; font-size: 20px">Samiti Name : <span id="search_key"></span></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th colspan="6" style="text-align:center; font-size: 15px">हस्ताक्षर <br>
                            केंद्र प्रभारी </th>
                    </tr>
                </tbody>
            </table>
