        ...
        <div class="panel-heading border-light">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <label>&nbsp; </label>
                    <div class="input-group">
                        <button type="button" class="btn btn-primary find_report" data-url="reports/outward/ajax_samiti"> <i class="fa fa-search"></i> Find</button>&nbsp;
