...
<div class="container-fluid container-fullw">
    <div class="panel panel-white" id="report_panel">
        <div class="panel-heading border-light">
            <h3>Outward Fisherman Report</h3>
            <div class="row">
                ...
                <div class="col-md-3">
                    <label>&nbsp; </label>
                    <div class="input-group">
                        <button type="button" class="btn btn-primary find_report" data-url="reports/outward/ajax_fisherman"> <i class="fa fa-search"></i> Find</button>&nbsp;
            ...
            <table class="table table-striped table-bordered" id="data-table-grid">
                <thead>
                    <tr>
                        ...
                        <th colspan="5" style="text-align:right; font-size: 20px">Date : <span id="search_date"></span></th>
                    </tr>
                    <tr>
                        <th width="10%">Fisherman </th>
                        <th width="10%">Partner Name</th>
                        <th width="10%">Jaal Total Quantity</th>
                        <th width="10%">Nav Total Quantity</th>
                        <th width="10%">Total Amount</th>
                        <th width="10%">Cash Paid</th>
                        <th width="10%">Adjustment through wages</th>
                        <th width="10%">Advance wages</th>
                        <th width="10%">Advance wages deduction</th>
                        <th width="10%">Total Pending</th>
                    </tr>
                </thead>
