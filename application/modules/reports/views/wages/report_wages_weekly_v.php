...
<div class="container-fluid container-fullw">
  <div class="panel panel-white" id="report_panel">
    <div class="panel-heading border-light">
      <h3>Samiti Wise Weekly Report</h3>
      <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                <button type="button" class="btn btn-primary find_report" data-url="reports/wages/ajax_weekly"> <i class="fa fa-search"></i> Find</button>&nbsp;
