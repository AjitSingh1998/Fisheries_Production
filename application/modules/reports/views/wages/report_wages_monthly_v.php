...
<div class="container-fluid container-fullw">
  <div class="panel panel-white" id="report_panel">
    <div class="panel-heading border-light">
      <h3>Samiti wise monthly report</h3>
      <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="input-group">
                <button type="button" class="btn btn-primary find_report" data-url="reports/wages/ajax_monthly"> <i class="fa fa-search"></i> Find</button>&nbsp;
    ...
    <div class="panel-body">
    	<div class="table-responsive">
              <table class="table table-striped table-bordered" id="data-table-grid">
                <thead>
                  <tr>
                    <th rowspan="2" width="10%">S.N. </th>
                    <th rowspan="2" width="10%">Samiti Name </th>
                    <th style="text-align:center;" id="search_date" colspan="0">Selected Month</th>
