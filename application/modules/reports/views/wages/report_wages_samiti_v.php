      ...
      <div class="row margin-bottom-10">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                <button type="button" class="btn btn-primary find_report" data-url="reports/wages/ajax_samiti"> <i class="fa fa-search"></i> Find</button>&nbsp;
