      ...
      <div class="row">
        ...
        <div class="col-md-2">
          ...
          <div class="input-group"> <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
            <input type="text" class="form-control yearpicker" placeholder="yyyy" name="date" autocomplete="off">
          </div>
        </div>
        ...
        <div class="col-md-3">
            ...
            <div class="input-group">
                <button type="button" class="btn btn-primary find_report" data-url="reports/wages/ajax_yearly"> <i class="fa fa-search"></i> Find</button>&nbsp;
