      ...
      <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="input-group">
                <button type="button" class="btn btn-primary find_report" data-url="reports/wages/ajax_account"> <i class="fa fa-search"></i> Find</button>&nbsp;
    	...
    	<div class="table-responsive">
          <table id="table_export" class="table table-striped table-bordered">
            <thead>
              ...
              <tr>
                <th rowspan="2" width="5%">Fisherman Name </th>
