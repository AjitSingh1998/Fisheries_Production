...
<div class="container-fluid container-fullw">
    <div class="panel panel-white" id="report_panel">
    	<div class="panel-heading light-border">
        	...
        	<?php echo form_open(site_url('wages/fisherman_wages_sheet'));?>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  <select class="form-control maingroup select2" name="maingroup">
                    <option value="">All</option>
                    <?php
                    if(!empty($allmaingroup)){
                        foreach($allmaingroup as $group){
                            $op_val = $group['ID'];
                            $op_text = $group['Name'];
                            $selected = '';
                            if(@$maingroup == $op_val) $selected = ' selected="selected"';
                    ?>
                    <option  <?=$selected?> value="<?=$op_val?>"><?=$op_text?></option>
                    <?php }} ?>
                  </select>
