...
<div class="container-fluid container-fullw">
  <div class="panel panel-white load1 csspinner" id="loader">
    <div class="panel-heading border-light light-bg">
      <h3 class="text-center"><a href="<?=site_url('wages/wages_sheet')?>" class=""><i class="fa fa-arrow-circle-left"></i> </a> <?=$page_title?></h3>
      ...
      <div class="row">
        ...
        <div class="col-md-2">
            ...
            <div class="input-group">
                <button type="button" class="btn btn-primary search_wages" <?=$disabled?>><i class="fa fa-search"></i> Search</button>&nbsp;
                <button type="button" data-pid="table#wages_sheet" data-fname="Wages Sheet" class="btn btn-warning export_fisherman_data" <?=$disabled_for_xp?>> <i class="fa fa-file-excel-o"></i> </button>&nbsp;
                <button type="button" data-pid="table#wages_sheet" class="btn btn-success print_fisherman_data" <?=$disabled_for_xp?>> <i class="fa fa-print"></i> </button>
            </div>
        </div>
		<div class="col-md-2">
        	<label>Show Fisherman</label><br />
    ...
    <div class="panel-body">
      <table class="table table-bordered table-striped" id="wages_sheet" width="130%">
        <thead>
          <tr>
            <th><span data-toggle="tooltip" title="Fisherman Code">F.Code</span></th>
            ...
            <th><span data-toggle="tooltip" title="Personal Liability">PL</span></th>
